...
var addSample = function(sampleId) {
  ...
  /// ### not very dry having this sampleHtml here and in the
  /// template. I could generate it to a hidden div with the partial
  /// and then populate it with javascript from there. otoh the player
  /// probably needs a major overhaul before it can be taken seriously
  /// so no point in spending time to improve this one.
  var sampleHtml = 
